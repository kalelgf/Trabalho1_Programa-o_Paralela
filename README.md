# Simulador de Fluxo de Vendas de Itens com Processamento Paralelo

## Grupo: Igor Velmud Bandero e Kalel Gomes Freitas
...
- Tempos definidos em microsegundos (`_US` para o tempo base e `_VAR` para uma variação adicional ao tempo base) podem ser alterados para simular gargalos no fluxo de trabalho.
